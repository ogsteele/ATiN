...
base_filename = '20190813_000.tdms';
% Load in original file
S = ephysIO('20190813_000.tdms');
% Split original file in half
ephysIO ('second_half.phy',(S.array(end-(length(S.array)/2):end,:)),S.xunit,S.yunit,S.names,S.notes,'int16')
% Load in second half recording
S = ephysIO('second_half.phy');
